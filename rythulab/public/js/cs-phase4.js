...
function p4_build(){
    ...
    var allCropRows=mc.map(function(c){return'<tr><td style="font-weight:700;color:var(--text-dark)">'+c.name+'</td><td style="color:#3a4a2a">Main crop</td><td>'+c.a.toFixed(1)+' ac</td></tr>';}).join("")+
